...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('frontend/images/logo.jpeg') }}" />
    ...
    <style>
        ...
        @media screen and (max-width:401px) {
            .terms-conditions.footer-wrapper.justify-content-center.px-0 .footer-section.f-section-1  {
        ...
        body {
            background: url('../backend/images/factor.jpeg');
                    ...
                    <div class="form-content">
                        ...
                        <div class="row text-center">
                            <div class="col col-12">
                                <a href="/">
                                    <img src="{{ asset('frontend/images/logo.jpeg') }}" width="40%" class=""
                                        alt="logo">
                                </a>
                            </div>
                            <div class="col col-12 py-3">
                                <h1 class="lh-30"><span class="brand-name custom-reset">Reset Password</span></h1>
